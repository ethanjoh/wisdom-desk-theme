...
- **🌓 주간/야간 일러스트 수동 토글 (v1.5.5)**: 일러스트 우측 상단에 위치한 감성적인 원형 토글 버튼을 클릭하여 언제든지 주간(`frontpage2.webp`)과 야간(`frontpage.webp`) 모드를 자유롭게 전환할 수 있으며, 브라우저 `localStorage`에 설정이 영구 저장됩니다.
